  ...
  <div class="wrapper row1">
    <header id="header" class="hoc clear">
      <div id="logo" class="fl_left"> 
        <!-- ################################################################################################ -->
        <h1><a href="index.ftl">Nocobot</a></h1>
        <!-- ################################################################################################ -->
      </div>
      <nav id="mainav" class="fl_right"> 
        ...
        <ul class="clear">
          ...
          <li><a class="drop" href="#">Pages</a>
            <ul>
              <li><a href="/static/pages/gallery.html">Gallery</a></li>
              <li><a href="/static/pages/full-width.html">Full Width</a></li>
              <li><a href="/static/pages/sidebar-left.html">Sidebar Left</a></li>
              <li><a href="/static/pages/sidebar-right.html">Sidebar Right</a></li>
              <li><a href="/static/pages/basic-grid.html">Basic Grid</a></li>
              <li><a href="/static/pages/font-icons.html">Font Icons</a></li>
            </ul>
          </li>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <section id="introblocks">
      <ul class="nospace group btmspace-80">
        <li class="one_third first">
          <figure><a class="imgover" href="#"><img src="/static/images/demo/348x400.png" alt=""></a>
            <figcaption>
    ...
    <!-- ################################################################################################ -->
    <section class="group">
      <div class="one_half first"><img class="inspace-15 borderedbox" src="/static/nocobot/images/demo/474x356.png" alt=""></div>
      <div class="one_half">
...
<div class="bgded overlay" style="background-image:url('/static/images/demo/backgrounds/01.png');">
  <figure class="hoc container clear imgroup"> 
    ...
    <ul class="nospace group">
      <li class="one_third"><a class="imgover" href="#"><img src="/static/images/demo/348x261.png" alt=""></a></li>
      <li class="one_third"><a class="imgover" href="#"><img src="/static/images/demo/348x261.png" alt=""></a></li>
      <li class="one_third"><a class="imgover" href="#"><img src="/static/images/demo/348x261.png" alt=""></a></li>
      <li class="one_third"><a class="imgover" href="#"><img src="/static/images/demo/348x261.png" alt=""></a></li>
      <li class="one_third"><a class="imgover" href="#"><img src="/static/images/demo/348x261.png" alt=""></a></li>
  ...
  <div class="hoc container clear"> 
    ...
    <ul class="nospace group team">
      <li class="one_quarter first">
        <figure><a class="imgover" href="#"><img src="/static/images/demo/300x300.png" alt=""></a>
...
<div class="wrapper row3">
  <figure class="hoc container clear clients"> 
    ...
    <ul class="nospace group">
      <li class="one_quarter first"><a class="imgover" href="#"><img src="/static/images/demo/249x100.png" alt=""></a></li>
      <li class="one_quarter"><a class="imgover" href="#"><img src="/static/images/demo/249x100.png" alt=""></a></li>
      <li class="one_quarter"><a class="imgover" href="#"><img src="/static/images/demo/249x100.png" alt=""></a></li>
      <li class="one_quarter"><a class="imgover" href="#"><img src="/static/images/demo/249x100.png" alt=""></a></li>
      <li class="one_quarter first"><a class="imgover" href="#"><img src="/static/images/demo/249x100.png" alt=""></a></li>
      <li class="one_quarter"><a class="imgover" href="#"><img src="/static/images/demo/249x100.png" alt=""></a></li>
...
<div class="wrapper bgded overlay" style="background-image:url('/static/images/demo/backgrounds/01.png');">
  <section id="testimonials" class="hoc container clear"> 
    ...
    <article class="btmspace-80">
      ...
      <figure class="clear"><img src="/static/images/demo/60x60.png" alt="">
        <figcaption>
...
<div class="wrapper row3">
  <section class="hoc container clear"> 
    ...
    <ul id="latest" class="nospace group">
      <li class="one_third first">
        <article><a class="imgover" href="#"><img src="/static/images/demo/348x261.png" alt=""></a>
...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div class="bgded overlay row4" style="background-image:url('/static/images/demo/backgrounds/01.png');">
  <footer id="footer" class="hoc clear"> 
    ...
    <div class="one_quarter">
      ...
      <ul class="nospace clear latestimg">
        <li><a class="imgover" href="#"><img src="/static/images/demo/100x100.png" alt=""></a></li>
        <li><a class="imgover" href="#"><img src="/static/images/demo/100x100.png" alt=""></a></li>
        <li><a class="imgover" href="#"><img src="/static/images/demo/100x100.png" alt=""></a></li>
        <li><a class="imgover" href="#"><img src="/static/images/demo/100x100.png" alt=""></a></li>
        <li><a class="imgover" href="#"><img src="/static/images/demo/100x100.png" alt=""></a></li>
