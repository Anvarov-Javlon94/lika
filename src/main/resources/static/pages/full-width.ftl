      ...
      <nav id="mainav" class="fl_right"> 
        ...
        <ul class="clear">
          ...
          <li class="active"><a class="drop" href="#">Pages</a>
            <ul>
              <li><a href="gallery.ftl">Gallery</a></li>
              <li class="active"><a href="full-width.ftl">Full Width</a></li>
              <li><a href="sidebar-left.ftl">Sidebar Left</a></li>
              <li><a href="sidebar-right.ftl">Sidebar Right</a></li>
              <li><a href="basic-grid.ftl">Basic Grid</a></li>
              <li><a href="font-icons.ftl">Font Icons</a></li>
            </ul>
          </li>
